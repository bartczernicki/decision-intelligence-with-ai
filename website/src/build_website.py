...
.notebook-content .text_cell_render > table {
  display: block;
  width: 100%;
  overflow-x: auto;
...
.notebook-content .text_cell_render > table th,
.notebook-content .text_cell_render > table td {
  padding: 12px 14px;
  border-bottom: 1px solid var(--line);
  vertical-align: top;
}
.notebook-content .text_cell_render > table th {
  background: color-mix(in srgb, var(--panel-warm) 84%, var(--gold));
  border-bottom: 1px solid color-mix(in srgb, var(--gold) 46%, var(--line));
  color: var(--heading);
}
.notebook-content .text_cell_render > table tbody tr:hover {
  background: color-mix(in srgb, var(--panel-warm) 72%, var(--gold));
}
